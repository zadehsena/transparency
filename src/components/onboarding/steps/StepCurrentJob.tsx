...
import { saveCurrentJob } from "@/app/onboarding/actions";

export default function StepCurrentJob() {
    ...
    const submit = () => {
        if (!company.trim() || !title.trim()) return setErr("Company and title are required");
        setErr(null);
    ...
    return (
        <div>
            <h2 className="mb-2 text-xl font-bold text-gray-900 dark:text-gray-100">Current job</h2>
            <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">Where do you work now?</p>
            ...
            <div className="mb-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
                <input
                    ...
                    placeholder="Company (e.g., Oracle)"
                    value={company}
