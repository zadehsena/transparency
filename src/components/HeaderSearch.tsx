...
export default function HeaderSearch() {
  ...
  return (
    <div className="relative flex w-full items-center gap-2" role="combobox" aria-expanded={open} aria-controls="company-ac-list" aria-haspopup="listbox">      <div className="relative flex-1">
      {/* search icon */}
      <svg
