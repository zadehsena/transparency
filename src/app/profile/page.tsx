...
export default function ProfilePage() {
  ...
  if (loading || !form) {
    return (
      <section className="mx-auto max-w-3xl p-8 space-y-4">
  ...
  return (
    <section className="mx-auto max-w-3xl p-6 md:p-8 space-y-8">
      {/* Header + Stats */}
      ...
      <Section title="Job preferences">
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          <TagInput
            ...
            onChange={(vals) => update("jobTypes", vals)}
            placeholder="e.g., full‑time, contract…"
          />
          <TagInput
            label="Preferred locations"
            values={form.preferredLocations}
            onChange={(vals) => update("preferredLocations", vals)}
            placeholder="e.g., Remote, Raleigh NC…"
          />
        </div>
      </Section>
